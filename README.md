...
<span>[ English | <a href="README_zh.md">چینی</a> | <a href="README_ja.md">ژاپنی</a> ]</span>
...
- [2025/2] StepFunc implements a [single-controller version of OpenRLHF].
...
- Support for [Iterative DPO](./examples/scripts/train_iterative_dpo_llama.sh) ([GitHub: Online-RLHF]).  
- Support for [Rejection Sampling](./examples/scripts/train_rejection_sampling_llama.sh).  
- Implementation of [Conditional SFT](./examples/scripts/train_conditional_llama.sh) ([arXiv:2308.12050]).  
- Support for [Knowledge Distillation](./examples/scripts/train_knowledge_distillation.sh) ([Microsoft: minillm]).  
...
1. You can also join us through the official GitHub [OpenRLHF ↗] project page. Just create an issue about your interest to contribute and we will get back to you.
